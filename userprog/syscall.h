...
/*
 * Read number from console and print number
 */ 
int ReadNum();
void PrintNum(int num);
/*
 * Read char from console and print char
 */ 
char ReadChar();
void PrintChar(char character);

/*
* Read a string with 'length' from console
*/
void ReadString(char buffer[], int length);

/*
* Print string from 'buffer' to console.
*/
